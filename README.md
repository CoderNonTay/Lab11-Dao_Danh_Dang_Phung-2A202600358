...
If you are on Windows and want to run the NeMo Guardrails part locally, install
Microsoft C++ Build Tools first, or install `nemoguardrails` separately in a
...
- **OpenAI GPT-4o-mini** — LLM backend (can be swapped if needed)
...
| 2 | Generate attack test cases with AI | OpenAI (gpt-4o-mini) |
...
| 7 | LLM-as-Judge safety check | OpenAI (gpt-4o-mini) |
